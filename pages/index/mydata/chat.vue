			...
			<view>
				<uni-popup
					...
					<scroll-view style="width: 500px;height: 500px;overflow-y: scroll;">
						<view style="text-align: center;">公文</view>
						<uni-collapse>
							<uni-collapse-item title="格式信息">
								<uni-forms-item name="age" required label="发电单位">
									<uni-easyinput placeholder="请输入发电单位"></uni-easyinput>
								</uni-forms-item>
								<uni-forms-item name="email" label="签发人">
									<uni-easyinput placeholder="请输入签发人"></uni-easyinput>
								</uni-forms-item>
								<uni-forms-item name="email" label="发电时间">
									<uni-data-pickerview></uni-data-pickerview>
								</uni-forms-item>
								<uni-forms-item name="email" label="等级">
									<uni-easyinput placeholder="请输入等级"></uni-easyinput>
								</uni-forms-item>
								<uni-forms-item name="email" label="标题">
									<uni-easyinput placeholder="请输入标题"></uni-easyinput>
								</uni-forms-item>
								<uni-forms-item name="email" label="抬头">
									...
									<radio-group @change="radioChange">
										...
										<view v-for="(item1,indexRadio) in items" :key="item1.value">
											<view>
												...
												<uni-easyinput type="textarea" :text="item1.text" placeholder="请输入内容">
												</uni-easyinput>
											</view>
					...
					<view>
						<text class="uni-tip-button">取消</text>
						<text class="uni-tip-button">确定</text>
					</view>
